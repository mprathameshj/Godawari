...
public class RecentAdaptor1 extends RecyclerView.Adapter<RecentAdaptor1.ViewHolder> {

    ArrayList<RecentModel> list=new ArrayList<>();
    Context context;

    public RecentAdaptor1(ArrayList<RecentModel> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.sample_recent_1,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            Image=itemView.findViewById(R.id.Image_Recent_1);
            Name=itemView.findViewById(R.id.Name_recent_1);
        }
    }
}
